...
describe('most blogs', () => {
  ...
  test('when list has only one blog, it is the top blogger', () => {
    ...
    expect(result).toEqual(expectedTopBlogger)
  })
...
describe('most likes', () => {
  ...
  test('when list has only one blog, it is the top liked blogger', () => {
    const result = listHelper.mostLikes(listWithOneBlog)
    const expectedTopLikedBlogger = {
      author: 'Edsger W. Dijkstra',
      likes: 5,
    }
    expect(result).toEqual(expectedTopLikedBlogger)
  })
